...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        description="Clean and validate external madlad_4gpu_full_merged dataset files."
    )
    parser.add_argument(
        "--input-dir",
        default="datasets_external/madlad_4gpu_full_merged",
        help="Input directory containing operators_alpaca_ro.jsonl and queries_alpaca_ro.jsonl",
    )
    parser.add_argument(
        "--output-dir",
        default="datasets/madlad_4gpu_full_merged_clean",
